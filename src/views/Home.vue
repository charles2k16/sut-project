              ...
              <div class="about-active">
                <div class="single-about-wrap">
                  <div class="row align-items-center">
                    <div class="col-lg-6">
                      <div class="about-img">
                        <img src="../assets/img/about_img01.png" alt="img" />
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="about-content">
                        ...
                        <p>
                          ...
                          logistics solution for the delivery of small cargo.
                          This service is useful for companies of various
                          effective logistics scale.
                        </p>
                ...
                <div class="single-about-wrap">
                  <div class="row align-items-center">
                    <div class="col-lg-6">
                      <div class="about-img">
                        <img src="../assets/img/about_img02.png" alt="img" />
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="about-content">
                        <div class="section-title about-title mb-25">
                          <h2>Logistics Cargo Service</h2>
                          <h6>Express delivery is an innovative service</h6>
                        </div>
                        <p>
                          Express delivery is an innovative service is effective
                  ...
                  <div class="single-testimonial">
                    ...
                    <div class="testimonial-content mb-45">
                      <p>
                        “ Express delivery is an innovative service is effective
                        logistics solution for the delivery of small cargo. This
                        service is useful companied various effective logistics
                        scala ”
                      </p>
                    </div>
                    <div class="testimonial-avatar">
                      <div class="testi-avatar-img">
                        <img src="../assets/img/testi_avatar01.png" alt="img" />
                      </div>
              ...
              <div class="cta-area cta-pl">
                ...
                <div class="cta-from">
                  <form action="#">
                    ...
                    <h4 class="extra-services">
                      <i class="fas fa-binoculars"></i>Extra Service
                    </h4>
                    <ul>
                      <li>
          ...
          <div class="row gallery-active">
            <div class="col-lg-8 col-md-12 grid-item grid-sizer">
              <div class="single-gallery-img mb-30">
                <a href="#"
                  ><img src="../assets/img/gallery_thumb01.jpg" alt="img"
                /></a>
                <div class="gallery-overlay">
                  <h5 class="gallery-overlay-title">
                    <a href="#">Cargo Truck</a>
                  </h5>
            ...
            <div class="col-lg-4 col-md-6 grid-item grid-sizer">
              <div class="single-gallery-img mb-30">
                <a href="#"
                  ><img src="../assets/img/gallery_thumb02.jpg" alt="img"
                /></a>
                <div class="gallery-overlay">
                  <h5 class="gallery-overlay-title">
                    <a href="#">Cargo Truck</a>
            ...
            <div class="col-lg-4 col-md-6 grid-item grid-sizer">
              <div class="single-gallery-img mb-30">
                <a href="#"
                  ><img src="../assets/img/gallery_thumb04.jpg" alt="img"
                /></a>
                <div class="gallery-overlay">
                  <h5 class="gallery-overlay-title">
                    <a href="#">Cargo Truck</a>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="single-fact mb-50">
                ...
                <div class="fact-content">
                  ...
                  <p>
                    Express delivery is an innaiv service effective logistics
                    solution
                  </p>
                </div>
              </div>
          ...
          <div class="row align-items-center">
            <div class="col-xl-5 col-lg-6">
              <div class="section-title mb-25">
                ...
                <h2>Explore Airtrans Services Control <span>Shiping</span></h2>
              </div>
              <div class="extra-features-content">
                <h5>
                  Express delivery innovative service effective logistics
                  solution for the delivery small cargo.
                </h5>
                <p>
                  Express delivery is an innovative service is effective logi
                  solution for the delivery of small cargo. This service is use
                  for companies of various effective logisti scale.Express
                  delivery.
                </p>
                <a href="#" class="btn">Get Fare Rate</a>
              </div>
            </div>
            <div class="col-xl-7 col-lg-6">
              <div class="extra-features-img">
                <img
                  src="../assets/img/extra_features_img.png"
          ...
          <div class="row brand-active">
            <div class="col-12">
              <div class="signle-brand">
                <img src="../assets/img/brnad_logo01.png" alt="img" />
              </div>
            </div>
            <div class="col-12">
              <div class="signle-brand">
                <img src="../assets/img/brnad_logo02.png" alt="img" />
              </div>
            </div>
            <div class="col-12">
              <div class="signle-brand">
                <img src="../assets/img/brnad_logo03.png" alt="img" />
              </div>
            </div>
            <div class="col-12">
              <div class="signle-brand">
                <img src="../assets/img/brnad_logo04.png" alt="img" />
              </div>
            </div>
            <div class="col-12">
              <div class="signle-brand">
                <img src="../assets/img/brnad_logo05.png" alt="img" />
              </div>
            </div>
            <div class="col-12">
              <div class="signle-brand">
